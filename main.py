...
def process_stock_logic(df, stock_info):
    ...
    return {
        ...
        "现价": curr["close"], 
        "今日涨跌": f"{today_pct:+.2f}%", 
        "近3日涨跌": pct_3day_str, # 🔥 [已修改] 显示近3日明细
...
def save_and_beautify(data_list):
    ...
    filename = f"严选_小白无障碍版_{dt_str}.xlsx"
    ...
    ws.column_dimensions['J'].width = 28 # 🔥 调宽近3日涨跌列
